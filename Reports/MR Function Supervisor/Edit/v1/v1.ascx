<%@ Control Language="C#" AutoEventWireup="true" CodeFile="v1.ascx.cs" Inherits="Reports_MR_Function_Supervisor_Edit_v1_v1" %>
...
<div class="body3">
    ...
    <table class="table-incident">
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtFunctionName" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="30px" Style="resize: none;"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtNoOfGuests" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="30px" Width="50px" Style="resize: none;"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtSetup" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="50px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtMenuFeedback" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtBarFeedback" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="130px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtStaffIssues" class="object-default" OnTextChanged="TextChanged_TextChanged" runat="server" Height="50px" Style="resize: none;" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="4">
                <asp:TextBox ID="txtGeneralComms" class="object-default" OnTextChanged="TextChanged_TextChanged" TextMode="MultiLine" runat="server" Height="80px" Text="" Style="resize: none;"></asp:TextBox>
            </td>
        </tr>
    </table>
</div>
